  ...
  render: function() {
    ...
    return (
      <div className="row" onClick={this.handleRowClick} ref="row">
        <ChecklistItemForm ref="form" name={name} method="patch" item={this.state.item} editMode={this.currentlyInEditMode()} formClass="edit_checklist_item" formAjaxSuccess={this.formAjaxSuccess} />
